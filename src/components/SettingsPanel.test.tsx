...
describe('SettingsPanel', () => {
  it('renders correctly', () => {
    const { container } = render(<SettingsPanel settings={mockSettings} profile={mockProfile} onUpdateSettings={vi.fn()} onUpdateProfile={vi.fn()} onResetProgress={vi.fn()} onOpenAuthModal={vi.fn()} />);
